...
class OERPreprocessor:
    def __init__(self, file_path):
        # Initialize with file path and set up embedder and vector database
...
if __name__ == "__main__":
    # List of PDF files to preprocess
    file_paths = [
